...
contract ERC1155 is IERC1155, ERC165, CommonConstants, Ownable
{
    ...
    //All the ids of the items ever created
...
/////////////////////////////////////////// ERC165 //////////////////////////////////////////////
    ...
    */
    ...
    //Adds id to existence
    function addID(uint256 _id) internal
    {
        //If id added for first time, add it to the list that contains all ids in existence
        if(!idExist[_id])
        {
            idExist[_id] = true;
            itemIDs.push(_id);
    ...
    function getItemIDsLength() public view returns (uint)
    {
